...
- `tasks/`:
  ...
  - `transfer_globus.py`: reuse the Globus transfer task from `examples/pipeline/multi_facilities/tasks/`.
...
- Reference implementation: `examples/pipeline/multi_facilities/tasks/transfer_globus.py`
- Wrapper example: `examples/pipeline/multi_facilities/tasks/globus_transfer.sh`
