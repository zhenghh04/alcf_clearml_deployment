...
pip install -r tests/experiment_tracking/resnet50_conversion/requirements.txt
```

### 1) W&B example

```
python tests/experiment_tracking/resnet50_conversion/resnet50_wandb.py \
...
```
python tests/experiment_tracking/resnet50_conversion/resnet50_mlflow.py \
  --epochs 1 --batch-size 32
```
...
```
python tests/experiment_tracking/resnet50_conversion/resnet50_clearml.py \
  --epochs 1 --batch-size 32
```
